# backend/app/api/admin_api/billing.py
import logging
...
router = APIRouter(prefix="/billing", tags=["Admin API — Billing"])
...
async def list_invoices(
    ...
    """List invoices with optional status and organization filters."""
    conditions = ["TRUE"]
    ...
    invoices = [_serialize(dict(r)) for r in result.mappings()]
...
async def retry_invoice_payment(
    ...
    await write_admin_audit(
        db, ctx, "admin_panel.billing.retry", invoice_id
    )
